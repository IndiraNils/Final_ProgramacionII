...
@Entity //Esta clase se va a mapear como una tabla
...
public class Videojuego {
    //IDENTITY: autoincremental y no nulo
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private long id;

    @NotEmpty(message = "Debe completar el campo del titulo")
    ...
    @NotNull(message="El campo de fecha no puede nulo")
